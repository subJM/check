...
const sendToken = async () => {
  try {
    ...
    await handleClick();
    var RequestApi = "http://1.231.89.30:3000/token/sendETH";
    if (selectedCoin.value != "ETH") {
      RequestApi = "http://1.231.89.30:3000/token/sendToken";
    }
    // var RequestApi = "http://1.231.89.30:3000/token/test2";
  ...
  try {
    ...
    if (selectedCoin.value == "ETH") {
      if (token_name.value == "ETH") {
        ...
        url = "http://1.231.89.30:3000/users/getAddressBalance";
      } else {
        form = {
          user_id: user_id,
          token_name: token_name.value,
